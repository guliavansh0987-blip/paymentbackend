...
/**
 * Get a user's existing ZapAPI key, creating one on first call.
 */
...
/**
 * Issue a brand new ZapAPI key for a user, replacing any previous one.
...
/**
 * Resolve a ZapAPI key to its owning userId. Returns null if the key
